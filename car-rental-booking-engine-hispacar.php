...
function c_h_h_af_cod_setting() {
	...
	echo "<input id='af_cod_text_string' name='c_h_h_options[af_cod]' size='40' type='text' value='{$options['af_cod']}' /><br/><small><a href='https://www.hispacar.com/wordpress-plugins/search/" . $lang . "/register/' target='_blank'>" . __('How do I get one?', 'c-h-hispacar') . "</a></small>";
}
...
function c_h_h_pickup_id_setting() {
	$options = get_option('c_h_h_options');
	echo "<input id='pickup_id' name='c_h_h_options[pickup_id]' size='15' type='text' value='{$options['pickup_id']}' /><br/><small><a href='#'onclick=\"javascript:window.open('https://www.hispacar.com/affiliate/id_selector/id_selector.php?lang=" . $options['lang'] . "', '', 'width=520, height=320')\">" . __('Help me find the id', 'c-h-hispacar') . "</a></small>";
}
...
function c_h_h_color_setting() {
	$options = get_option('c_h_h_options');
	echo "#<input id='color' name='c_h_h_options[color]' size='6' type='text' value='{$options['color']}' /><br/><small><a href='#' onclick=\"javascript:window.open('https://www.hispacar.com/affiliate/colorpicker/colorpicker.php?lang=" . $options['lang'] . "', '', 'width=320, height=300')\">" . __('Help me find the color code', 'c-h-hispacar') . "</a></small>";
}


function c_h_h_background_color_setting() {
	$options = get_option('c_h_h_options');
	echo "#<input id='background_color' name='c_h_h_options[background_color]' size='6' type='text' value='{$options['background_color']}' /><br/><small><a href='#' onclick=\"javascript:window.open('https://www.hispacar.com/affiliate/colorpicker/colorpicker.php?lang=" . $options['lang'] . "', '', 'width=320, height=300')\">" . __('Help me find the color code', 'c-h-hispacar') . "</a></small>";
}


function c_h_h_button_color_setting() {
	$options = get_option('c_h_h_options');
	echo "#<input id='color' name='c_h_h_options[button_color]' size='6' type='text' value='{$options['button_color']}' /><br/><small><a href='#' onclick=\"javascript:window.open('https://www.hispacar.com/affiliate/colorpicker/colorpicker.php?lang=" . $options['lang'] . "', '', 'width=320, height=300')\">" . __('Help me find the color code', 'c-h-hispacar') . "</a></small>";
}

function c_h_h_button_text_color_setting() {
	$options = get_option('c_h_h_options');
	echo "#<input id='color' name='c_h_h_options[button_text_color]' size='6' type='text' value='{$options['button_text_color']}' /><br/><small><a href='#' onclick=\"javascript:window.open('https://www.hispacar.com/affiliate/colorpicker/colorpicker.php?lang=" . $options['lang'] . "', '', 'width=320, height=300')\">" . __('Help me find the color code', 'c-h-hispacar') . "</a></small>";
}
...
function c_h_h_render($type='full'){
	...
	$template .= "\n" . '<form method="post" class="' . $formStyle . '" action="https://www.hispacar.com/affiliate/redir.php" target="_blank" onsubmit="javascript:return c_h_h_validate_form()">';
	$template .= "\n" . '<h6>' . $title . '</h6>';
...
function WPC_H_H_scripts(){
	...
	if (!is_admin()){
		...
		wp_enqueue_style('c_h_h_jquery-ui-css', 'https://ajax.googleapis.com/ajax/libs/jqueryui/1.8.21/themes/smoothness/jquery-ui.css');
